...
async function runAudit() {
  console.log('🚀 Running Baseline Layout Audit with Playwright...');
  ...
  const fs = require('fs');
  fs.writeFileSync('scratch/audit_results_before.json', JSON.stringify(allFindings, null, 2));
  console.log('Saved findings to scratch/audit_results_before.json');
}
