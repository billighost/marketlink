...
export function Illustration({
  ...
  const renderContent = () => {
    switch (name) {
      ...
      // Potatoes: cluster of earthy russets with subtle eyes
      case 'potatoes':
        return (
          <>
            <ellipse cx="32" cy="46" rx="18" ry="14" className={styles.fillCanvas} />
            <ellipse cx="48" cy="42" rx="17" ry="13" className={styles.fillCanvasMedium} />
            <ellipse cx="36" cy="34" rx="14" ry="11" className={styles.fillCanvas} />
            {/* Eyes and skin texture */}
            <circle cx="28" cy="44" r="1" className={styles.line} />
            <circle cx="36" cy="48" r="1" className={styles.line} />
            <circle cx="52" cy="40" r="1" className={styles.line} />
            <circle cx="45" cy="44" r="1" className={styles.line} />
            <circle cx="34" cy="33" r="1" className={styles.line} />
            <path d="M40 32 Q42 35 44 32" className={styles.subtleLine} />
            <path d="M48 45 Q51 47 54 44" className={styles.subtleLine} />
          </>
        );

      // Corn: golden cob with leafy husk peeling back
      case 'corn':
        return (
          <>
            {/* Husks */}
            <path d="M26 65 C22 45 24 30 36 22 C30 36 34 52 38 65 Z" className={styles.fillHerb} />
            <path d="M54 65 C58 45 56 30 44 22 C50 36 46 52 42 65 Z" className={styles.fillHerb} />
            {/* Cob */}
            <path d="M33 55 C32 35 34 20 40 16 C46 20 48 35 47 55 Z" className={styles.fillCarrot} />
            {/* Kernel grid lines */}
            <line x1="35" y1="26" x2="45" y2="26" className={styles.subtleLine} />
            <line x1="34" y1="33" x2="46" y2="33" className={styles.subtleLine} />
            <line x1="33" y1="40" x2="47" y2="40" className={styles.subtleLine} />
            <line x1="33" y1="47" x2="47" y2="47" className={styles.subtleLine} />
            <line x1="40" y1="18" x2="40" y2="55" className={styles.subtleLine} />
            {/* Silk tassel */}
            <path d="M40 16 Q42 10 44 8" className={styles.line} />
            <path d="M39 16 Q37 11 36 9" className={styles.line} />
          </>
        );

      // Butternut squash: curved neck and bulbous base
      case 'squash':
        return (
          <>
            {/* Stem */}
            <path d="M40 18 L41 12 C41 11 43 11 43 13 L42 18" className={styles.fillHerb} />
            {/* Squash body */}
            <path
              d="M36 24 C34 32 30 38 24 46 C18 54 22 66 32 68 C40 70 48 70 56 65 C64 60 62 48 56 46 C50 38 46 32 44 24 C44 20 36 20 36 24 Z"
              className={styles.fillCarrot}
            />
            {/* Curving contour lines */}
            <path d="M38 28 C36 38 33 48 30 58" className={styles.subtleLine} />
            <path d="M42 28 C44 38 47 48 50 58" className={styles.subtleLine} />
          </>
        );

      // Apples: crisp orchard apples with leaf
      case 'apples':
        return (
          <>
            {/* Back apple */}
            <path
              d="M44 34 C44 26 54 26 56 32 C64 34 66 48 60 56 C56 62 48 60 46 56 C44 50 42 42 44 34 Z"
              className={styles.fillBeet}
            />
            {/* Front apple */}
            <path
              d="M28 32 C30 25 38 25 40 30 C42 25 50 25 52 32 C58 40 56 56 46 62 C42 64 38 64 34 62 C24 56 22 40 28 32 Z"
              className={styles.fillCarrot}
            />
            {/* Stem & leaf */}
            <path d="M40 28 Q41 20 44 16" className={styles.line} />
            <ellipse cx="48" cy="20" rx="5" ry="3" transform="rotate(-20 48 20)" className={styles.fillHerb} />
            <path d="M38 36 Q35 44 36 52" className={styles.subtleLine} />
          </>
        );

      // Pears: single elegant teardrop pear with stem and leaf
      case 'pears':
        return (
          <>
            {/* Stem & leaf */}
            <path d="M38 22 Q37 14 34 11" className={styles.line} />
            <ellipse cx="44" cy="18" rx="6" ry="3" transform="rotate(-15 44 18)" className={styles.fillHerb} />
            {/* Pear shape */}
            <path
              d="M36 24 C34 32 30 38 24 48 C18 58 24 68 40 68 C56 68 62 58 56 48 C50 38 46 32 44 24 C44 18 36 18 36 24 Z"
              className={styles.fillCanvasMedium}
            />
            <path d="M38 32 Q35 44 37 56" className={styles.subtleLine} />
          </>
        );

      // Strawberries: ripe berry with calyx and seed dots
      case 'strawberries':
        return (
          <>
            {/* Front plump strawberry */}
            <path
              d="M26 34 C24 24 38 22 40 26 C42 22 56 24 54 34 C52 48 44 62 40 66 C36 62 28 48 26 34 Z"
              className={styles.fillBeet}
            />
            {/* Calyx leaves */}
            <path d="M40 24 L36 20 L38 24 L32 24 L37 27 L33 30 L39 28 L40 32 L41 28 L47 30 L43 27 L48 24 L42 24 L44 20 Z" className={styles.fillHerb} />
            <path d="M40 22 Q42 16 40 14" className={styles.line} />
            {/* Seeds */}
            <circle cx="34" cy="36" r="1" className={styles.fillWhite} />
            <circle cx="44" cy="36" r="1" className={styles.fillWhite} />
            <circle cx="38" cy="42" r="1" className={styles.fillWhite} />
            <circle cx="46" cy="46" r="1" className={styles.fillWhite} />
            <circle cx="34" cy="48" r="1" className={styles.fillWhite} />
            <circle cx="40" cy="54" r="1" className={styles.fillWhite} />
          </>
        );

      // Blueberries: bunch of plump berries with star calyxes
      case 'blueberries':
        return (
          <>
            <circle cx="30" cy="38" r="11" className={styles.fillCanvasMedium} />
            <circle cx="50" cy="36" r="12" className={styles.fillCanvas} />
            <circle cx="40" cy="50" r="13" className={styles.fillCanvasMedium} />
            {/* Calyx stars */}
            <path d="M30 35 L28 37 L31 39 L33 37 Z" className={styles.subtleLine} />
            <path d="M50 33 L48 35 L51 37 L53 35 Z" className={styles.subtleLine} />
            <path d="M40 47 L38 49 L41 51 L43 49 Z" className={styles.subtleLine} />
            <path d="M38 24 Q40 28 42 26" className={styles.line} />
            <ellipse cx="44" cy="24" rx="5" ry="3" transform="rotate(-30 44 24)" className={styles.fillHerb} />
          </>
        );

      // Croissant: curved layered golden pastry
      case 'croissant':
        return (
          <>
            {/* Outer crescent */}
            <path
              d="M16 52 C14 42 22 28 40 28 C58 28 66 42 64 52 C58 48 54 44 48 42 C40 40 32 40 26 44 C22 47 18 50 16 52 Z"
              className={styles.fillCanvasMedium}
            />
            {/* Central laminated rolls */}
            <path d="M30 32 C34 40 34 50 31 54" className={styles.line} />
            <path d="M40 28 C42 38 42 48 40 56" className={styles.line} />
            <path d="M50 32 C46 40 46 50 49 54" className={styles.line} />
            <path d="M22 38 C26 44 26 50 24 53" className={styles.subtleLine} />
            <path d="M58 38 C54 44 54 50 56 53" className={styles.subtleLine} />
          </>
        );

      // Cheese: golden wedge with cut eyes
      case 'cheese':
        return (
          <>
            {/* Wedge top and front */}
            <path d="M20 54 L60 54 L62 38 L38 24 L20 54 Z" className={styles.fillCarrot} />
            <path d="M38 24 L62 38 L62 44 L38 30 Z" className={styles.fillCanvasMedium} />
            {/* Cheese eyes/holes */}
            <ellipse cx="32" cy="44" rx="4" ry="3" className={styles.fillCanvas} />
            <ellipse cx="48" cy="46" rx="5" ry="4" className={styles.fillCanvas} />
            <ellipse cx="42" cy="36" rx="3" ry="2" className={styles.fillCanvas} />
            <ellipse cx="24" cy="51" rx="2" ry="1.5" className={styles.fillCanvas} />
          </>
        );

      // Milk bottle: classic glass dairy bottle with cream top
      case 'milk-bottle':
        return (
          <>
            {/* Bottle cap */}
            <rect x="34" y="14" width="12" height="4" rx="1.5" className={styles.fillHerb} />
            {/* Bottle neck & body */}
            <path
              d="M36 18 L36 26 C36 30 26 36 26 44 L26 64 C26 67 29 69 32 69 L48 69 C51 69 54 67 54 64 L54 44 C54 36 44 30 44 26 L44 18 Z"
              className={styles.fillWhite}
            />
            {/* Cream line */}
            <path d="M26 40 Q40 42 54 40" className={styles.subtleLine} />
            {/* Glass reflection */}
            <line x1="30" y1="46" x2="30" y2="62" className={styles.subtleLine} />
          </>
        );

      // Herbs: potted fresh basil / herbs
      case 'herbs':
        return (
          <>
            {/* Terracotta pot */}
            <path d="M28 50 L52 50 L48 70 L32 70 Z" className={styles.fillCanvasMedium} />
            <rect x="26" y="46" width="28" height="5" rx="1" className={styles.fillCanvas} />
            {/* Leafy sprigs */}
            <path d="M40 46 L40 22" className={styles.line} />
            <ellipse cx="34" cy="24" rx="7" ry="5" transform="rotate(-30 34 24)" className={styles.fillHerb} />
            <ellipse cx="46" cy="24" rx="7" ry="5" transform="rotate(30 46 24)" className={styles.fillHerb} />
            <ellipse cx="40" cy="18" rx="6" ry="4" className={styles.fillHerb} />
            <ellipse cx="30" cy="34" rx="6" ry="4" transform="rotate(-20 30 34)" className={styles.fillHerb} />
            <ellipse cx="50" cy="34" rx="6" ry="4" transform="rotate(20 50 34)" className={styles.fillHerb} />
          </>
        );

      // Flowers: fresh market bloom bouquet
      case 'flowers':
        return (
          <>
            {/* Stems & twine */}
            <line x1="40" y1="46" x2="38" y2="68" className={styles.line} />
            <line x1="40" y1="46" x2="32" y2="66" className={styles.line} />
            <line x1="40" y1="46" x2="48" y2="66" className={styles.line} />
            <line x1="33" y1="56" x2="47" y2="56" className={styles.woodLine} />
            {/* Left bloom */}
            <circle cx="28" cy="32" r="9" className={styles.fillBeet} />
            <circle cx="28" cy="32" r="3" className={styles.fillCarrot} />
            {/* Center bloom */}
            <circle cx="40" cy="24" r="11" className={styles.fillCarrot} />
            <circle cx="40" cy="24" r="4" className={styles.fillCanvasMedium} />
            {/* Right bloom */}
            <circle cx="52" cy="34" r="9" className={styles.fillBeet} />
            <circle cx="52" cy="34" r="3" className={styles.fillHerb} />
            {/* Leaves */}
            <ellipse cx="22" cy="42" rx="6" ry="3" transform="rotate(-35 22 42)" className={styles.fillHerb} />
            <ellipse cx="58" cy="42" rx="6" ry="3" transform="rotate(35 58 42)" className={styles.fillHerb} />
          </>
        );

      // Mushrooms: plump forest mushrooms with gills
      case 'mushrooms':
        return (
          <>
            {/* Left small mushroom */}
            <path d="M26 44 L28 62 L34 62 L33 44" className={styles.fillCanvas} />
            <path d="M18 44 C18 32 40 32 40 44 Z" className={styles.fillCanvasMedium} />
            {/* Right large mushroom */}
            <path d="M46 38 L48 64 L56 64 L54 38" className={styles.fillCanvas} />
            <path d="M34 38 C34 22 66 22 66 38 Z" className={styles.fillCanvasMedium} />
            {/* Cap spots */}
            <circle cx="46" cy="28" r="2" className={styles.fillWhite} />
            <circle cx="56" cy="30" r="1.5" className={styles.fillWhite} />
            <circle cx="50" cy="33" r="1" className={styles.fillWhite} />
          </>
        );

      // Fish: whole fresh market fish
      case 'fish':
        return (
          <>
            {/* Tail */}
            <path d="M60 40 L70 30 L67 40 L70 50 Z" className={styles.fillCanvasMedium} />
            {/* Body */}
            <path
              d="M14 40 C22 28 44 26 60 40 C44 54 22 52 14 40 Z"
              className={styles.fillCanvas}
            />
            {/* Eye and gill */}
            <circle cx="22" cy="38" r="2" className={styles.line} />
            <circle cx="22" cy="38" r="0.5" className={styles.fillWhite} />
            <path d="M28 34 C30 38 30 42 28 46" className={styles.line} />
            {/* Dorsal fin */}
            <path d="M36 30 C40 26 48 26 50 31" className={styles.fillCanvasMedium} />
            {/* Scales */}
            <path d="M36 38 Q39 40 36 42" className={styles.subtleLine} />
            <path d="M42 36 Q45 38 42 40" className={styles.subtleLine} />
            <path d="M42 42 Q45 44 42 46" className={styles.subtleLine} />
          </>
        );

      // Sausages: curved butcher link sausages
      case 'sausages':
        return (
          <>
            {/* First sausage link */}
            <path
              d="M18 34 C16 46 26 56 40 54 C38 48 28 42 26 32 C23 32 20 33 18 34 Z"
              className={styles.fillBeet}
            />
            {/* Second sausage link */}
            <path
              d="M40 54 C46 56 56 52 60 42 C56 38 48 44 42 50 C41 52 40 53 40 54 Z"
              className={styles.fillCarrot}
            />
            {/* Twine tie at end */}
            <circle cx="17" cy="33" r="2" className={styles.woodLine} />
            <circle cx="61" cy="41" r="2" className={styles.woodLine} />
            <path d="M26 42 Q32 46 36 48" className={styles.subtleLine} />
          </>
        );

      // Jam: glass jar with patterned fabric lid
      case 'jam':
        return (
          <>
            {/* Jar body */}
            <rect x="26" y="32" width="28" height="34" rx="4" className={styles.fillCanvas} />
            <rect x="28" y="36" width="24" height="28" rx="2" className={styles.fillBeet} />
            {/* Label */}
            <rect x="31" y="44" width="18" height="12" rx="1" className={styles.tagFill} />
            <line x1="34" y1="48" x2="46" y2="48" className={styles.subtleLine} />
            <line x1="36" y1="52" x2="44" y2="52" className={styles.subtleLine} />
            {/* Fabric bonnet lid & twine */}
            <path d="M22 30 C22 25 30 20 40 20 C50 20 58 25 58 30 Z" className={styles.fillCanvasMedium} />
            <path d="M20 31 Q23 34 26 31 Q29 34 32 31 Q35 34 38 31 Q41 34 44 31 Q47 34 50 31 Q53 34 56 31 Q59 34 60 31" className={styles.line} />
            <line x1="24" y1="30" x2="56" y2="30" className={styles.woodLine} />
          </>
        );
