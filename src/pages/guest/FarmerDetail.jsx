...
const FARMERS_DB = {
  'f-riverbend': {
    ...
    products: [
      ...
      {
        id: 'fp-carrots',
        name: 'Rainbow Nantes Carrots',
        category: 'Root Crops',
        price: '$4.50',
        unit: '/ bunch',
        stock: '15 bunches left',
        image: '/images/hero-carrots.jpg',
        badge: 'Field Fresh',
        desc: 'Sweet, crisp heritage Nantes carrots in purple, gold, and orange, freshly harvested with tops.',
      },
      {
        id: 'fp-sourdough',
        name: 'Farmhouse Sourdough Boule',
        category: 'Bakery',
        price: '$8.00',
        unit: '/ loaf',
        stock: '10 loaves left',
        image: '/images/product-sourdough.jpg',
        badge: 'Freshly Baked',
        desc: 'Slow cold-fermented sourdough boule crafted with locally stone-milled whole grains.',
      },
      {
        id: 'fp-kale',
        ...
        price: '$3.50',
        unit: '/ bunch',
        stock: '12 bunches left',
        image: '/images/product-lettuce.jpg',
        badge: 'Harvested Today',
        desc: 'Dark crinkly dinosaur kale leaves harvested at sunrise for peak sweetness and crunch.',
      },
      {
        id: 'fp-eggs',
        ...
        price: '$6.50',
        unit: '/ dozen',
        stock: '11 cartons left',
        image: '/images/hero-market-crates.jpg',
        badge: 'Pasture Raised',
        desc: 'Deep amber yolks from heritage breed hens foraging on organic rotational pasture.',
      },
      {
        id: 'fp-beets',
        name: 'Chioggia Candy-Stripe Beets',
        category: 'Root Crops',
        price: '$5.00',
        unit: '/ bunch',
        stock: '9 bunches left',
        image: '/images/hero-carrots.jpg',
        badge: 'Organic',
        desc: 'Tender sweet heirloom beets with vibrant pink and white concentric bullseye rings.',
      },
    ],
    reviews: [
      {
  ...
  'f-sunburst': {
    ...
    products: [
      {
        id: 'fp-sun-lettuce',
        name: 'Hydroponic Living Butterhead',
        category: 'Living Greens',
        price: '$3.00',
        unit: '/ head',
        stock: '15 heads left',
        image: '/images/product-lettuce.jpg',
        badge: 'Living Root',
        desc: 'Crisp, sweet, clean butterhead grown hydroponically without pesticides or chemical sprays.',
      },
      {
        id: 'fp-sun-microgreens',
        name: 'Spicy Microgreens Salad Mix',
        ...
        image: '/images/product-lettuce.jpg',
        badge: 'Harvested Today',
        desc: 'Nutrient-packed mix of spicy radish, purple kohlrabi, broccoli, and tender pea tendrils.',
      },
      {
        id: 'fp-sun-basil',
        name: 'Living Genovese Sweet Basil',
        category: 'Living Herbs',
        price: '$4.50',
        unit: '/ pot',
        stock: '14 pots left',
        image: '/images/product-lettuce.jpg',
        badge: 'Living Plant',
        desc: 'Aromatic kitchen windowsill basil grown in compostable coco peat with intact root ball.',
      },
      {
        id: 'fp-sun-kale',
        name: 'Clean CEA Baby Tuscan Kale',
        category: 'Living Greens',
        price: '$4.00',
        unit: '/ bag',
        stock: '10 bags left',
        ...
        desc: 'Tender baby kale leaves grown indoors with solar-powered spectrum lighting and pure water.',
      },
      {
        id: 'fp-sun-strawberries',
        name: 'Greenhouse Alpine Berries',
        category: 'Berries',
        price: '$7.00',
        unit: '/ pint',
        stock: '8 pints left',
        image: '/images/product-strawberries.jpg',
        badge: 'Hydroponic',
        desc: 'Naturally pollinated by indoor bumblebees, bursting with concentrated berry sweetness.',
      },
      {
        id: 'fp-sun-honey',
        name: 'Catskills Blossom Honey',
        category: 'Pantry',
        price: '$11.50',
        unit: '/ 12oz',
        stock: '16 jars left',
        image: '/images/product-honey.jpg',
        badge: 'Raw & Pure',
        desc: 'Cold-extracted raw wildflower honey harvested from hives along the Catskill foothills.',
      },
      {
        id: 'fp-sun-arugula',
        name: 'Wild Peppery Baby Rocket',
        category: 'Living Greens',
        price: '$3.75',
        unit: '/ bag',
        stock: '18 bags left',
        image: '/images/product-lettuce.jpg',
        badge: 'Fresh Harvest',
        desc: 'Sharp, peppery heirloom arugula leaves harvested daily from recirculating water beds.',
      },
      {
        id: 'fp-sun-mint',
        name: 'Fresh Potted Spearmint',
        category: 'Living Herbs',
        price: '$3.50',
        unit: '/ pot',
        stock: '11 pots left',
        image: '/images/product-lettuce.jpg',
        badge: 'Living Plant',
        desc: 'Vibrant and fragrant spearmint ready for fresh teas, cocktails, and kitchen salads.',
      },
      {
        id: 'fp-sun-tomatoes',
        name: 'Greenhouse Sugar Cherry Tomatoes',
        category: 'Vegetables',
        price: '$5.50',
        unit: '/ pint',
        stock: '13 pints left',
        image: '/images/product-tomatoes.jpg',
        badge: 'Vine Ripened',
        desc: 'Intensely sweet bite-sized red and orange cherry tomatoes vine-ripened on greenhouse trellises.',
      },
    ],
    reviews: [
  ...
  products: [
    {
      ...
      image: '/images/product-tomatoes.jpg',
      badge: 'Fresh Harvest',
      desc: 'Delicious locally grown heirloom tomatoes picked at peak ripeness.',
    },
    {
      id: 'fp-lettuce',
      name: 'Living Butterhead Lettuce',
      ...
      image: '/images/product-lettuce.jpg',
      badge: 'Harvested Today',
      desc: 'Tender buttery leaves harvested with root intact for crisp kitchen freshness.',
    },
    {
      id: 'fp-strawberries',
      name: 'Alpine Strawberries',
      ...
      image: '/images/product-strawberries.jpg',
      badge: 'Limited Crop',
      desc: 'Intensely fragrant petite European alpine strawberries bursting with sweetness.',
    },
    {
      id: 'fp-honey',
      ...
      image: '/images/product-honey.jpg',
      badge: 'Single Origin',
      desc: 'Unheated, unfiltered raw honey produced from bee boxes next to clover fields.',
    },
    {
      id: 'fp-carrots',
      name: 'Rainbow Nantes Carrots',
      ...
      price: '$4.50',
      unit: '/ bunch',
      stock: '14 bunches left',
      image: '/images/hero-carrots.jpg',
      badge: 'Field Fresh',
      desc: 'Crisp purple, gold, and sweet orange Nantes carrots with crisp leafy tops.',
    },
    {
      id: 'fp-sourdough',
    ...
    },
    {
      ...
      image: '/images/product-lettuce.jpg',
      badge: 'Harvested Today',
      desc: 'Dark crinkly dinosaur kale leaves harvested at sunrise for peak sweetness.',
    },
    {
      id: 'fp-eggs',
      name: 'Pasture-Raised Farm Eggs',
      ...
      image: '/images/hero-market-crates.jpg',
      badge: 'Pasture Raised',
      desc: 'Deep amber yolks from heritage breed hens foraging freely on open pasture.',
    },
    {
      id: 'fp-beets',
      name: 'Chioggia Candy-Stripe Beets',
      ...
      image: '/images/hero-carrots.jpg',
      badge: 'Organic',
      desc: 'Tender sweet heirloom beets with vibrant pink and white concentric rings.',
    },
  ],
  reviews: [
