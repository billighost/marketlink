...
import { MapPin, Clock, Info, Check, Bookmark, ExternalLink } from 'lucide-react';
...
export function MarketDetail() {
  ...
  useDocumentTitle(`${market?.name || 'Market'} · MarketLink`);
    ...
    return (
      <Page width="detail">
        <div className={styles.notFound}>
          ...
          <Link to="/buyer/markets" className={styles.backLink}>
            Back to markets
          </Link>
        </div>
      </Page>
  ...
  return (
    <Page width="detail">
      <PageTitle
        title={market.name}
        context={market.address}
        backTo="/buyer/markets"
