...
/**
 * Farmer detail page with Stock, Reviews, and About tabs.
...
export function FarmerDetail() {
  ...
  useDocumentTitle(`${farmer?.stallName || 'Stall'} · MarketLink`);
    ...
    return (
      <Page width="detail">
        <div className={styles.notFound}>
          ...
          <Link to="/buyer/stalls" className={styles.backLink}>
            Back to stalls
          </Link>
        </div>
      </Page>
        ...
        <header className={styles.hero}>
          ...
          <div className={styles.heroDetails}>
            <div className={styles.nameRow}>
              <h2 className={styles.stallName}>{farmer.stallName}</h2>
              <button
                type="button"
